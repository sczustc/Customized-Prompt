...
dataset_path = {
        ...
        'QFSD': ['dataset/QFSD/base', 'dataset/QFSD/val', 'dataset/QFSD/novel'],
}
    ...
    def __init__(self, dataset_name, aug, split='test'):
        ...
        if dataset_name == 'miniImageNet' or dataset_name == 'tieredImageNet':
            ...
            for idx in self.dataset.classes:
                text = idx.replace('_', ' ')
                self.idx2text[idx] = text
        elif dataset_name == 'QFSD':
            num_dict = {}
            with open('data/pest_Eng.txt', "r",encoding='utf-8') as f:
                for line in f:
                    number = line.split(':')[0]
            ...
            for idx in self.dataset.classes:
                text = idx.replace('_', ' ')
                self.idx2text[idx] = num_dict[text]         
